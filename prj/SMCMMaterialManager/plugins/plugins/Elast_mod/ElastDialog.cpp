#include "ElastDialog.h"
#include "ui_ElastDialog.h"
#include "QDebug"
#include "QFileDialog"
...
ElastPluginInterface::ElastPluginInterface()
{
...
QString ElastPluginInterface::getPluginName()
{
    return getMethodName();
}

AbstractInterfaceDialog *ElastPluginInterface::getPluginDialog()
{
    return (m_dialog);
}
